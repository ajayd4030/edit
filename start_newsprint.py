...
#config values
AUTH_TOKEN = "token a962a9d5ebc134f44cd80016ccbec50743407490"
giturl = "https://api.github.com/repos/alokamvenki402/satya_devops/"
...
username = "alokamvenki402"
password = "xxxxxxxxxx"
HEADER = {"Authorization": "bearer a962a9d5ebc134f44cd80016ccbec50743407490"}



API_PATH = "https://api.github.com/repos/alokamvenki402"
...
def updateContent(filePath, branchName, encodedString):
    try:
        print sha    
        put_data = { "branch": branchName, "content": encodedString, "message": commit_message, "sha": sha, "committer": { "name": "alokamvenki402", "email": "alokamvenki@gmail.com"}}
...
if __name__ == '__main__':
    ...
    print ('working on /satya_devops')
    get_it_done('/satya_devops')
